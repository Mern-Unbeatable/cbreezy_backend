...
for (const directory of [uploadsRoot, serviceImagesDir, serviceGalleryDir, eventImagesDir, eventGalleryDir, categoryImagesDir, profileImagesDir]) {
...
const storage = multer.diskStorage({
  ...
  filename: (req, file, callback) => {
    ...
    callback(null, `${Date.now()}-${sanitizedBaseName}${extension.toLowerCase()}`);
  }
});
