...
class AuthService {
  ...
  async register(userData) {
    ...
    // Find region by name and verify it belongs to the country
    ...
    // Normalize and find city by name and verify it belongs to the region
    ...
    if (!city) {
      throw new Error(`City '${normalizedCityName}' not found in ${regionName}`);
    }
